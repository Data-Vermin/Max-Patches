...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 854.0, 560.0, 50.0, 22.0 ],
					"text" : "record~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 609.0, 560.0, 174.0, 20.0 ],
					"text" : "stuff you could use if you want:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 592.0, 150.0, 20.0 ],
					"text" : "HINT: click help on these!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.0, 560.0, 150.0, 20.0 ],
					"text" : "Must use and understand:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 796.0, 560.0, 44.0, 22.0 ],
					"text" : "wave~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 448.0, 560.0, 38.0, 22.0 ],
					"text" : "play~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 378.0, 560.0, 52.0, 22.0 ],
					"text" : "groove~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 318.0, 560.0, 46.0, 22.0 ],
					"text" : "buffer~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 232.0, 299.0, 18.0 ],
					"text" : "should be elements that you can \"play\"",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 232.0, 23.0, 20.0 ],
					"text" : "4) "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 210.0, 185.0, 18.0 ],
					"text" : "the tempo must be changeable",
					"textcolor" : [ 0.292172193527222, 0.0, 0.998296856880188, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 210.0, 19.0, 20.0 ],
					"text" : "3)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 420.0, 938.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 184.0, 445.0, 18.0 ],
					"text" : "use more than one sample in one object and make sure it is changeable",
					"textcolor" : [ 0.292172193527222, 0.0, 0.998296856880188, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 60.0, 848.0, 33.0 ],
					"text" : "This assignment is open ended, but has some requirements below. You are going to use buffer~, groove~, and play~ and construct a \"duet\" again. Do not use the playlist object"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.0, 258.0, 52.0, 18.0 ],
					"text" : "unicorn",
					"textcolor" : [ 0.292172193527222, 0.0, 0.998296856880188, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 162.0, 397.0, 18.0 ],
					"text" : "incorporate automation in manipulating the sample playback",
					"textcolor" : [ 0.292172193527222, 0.0, 0.998296856880188, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 316.0, 879.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 751.813477000000148, 279.0, 145.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 279.0, 947.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 256.0, 349.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 377.0, 940.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 342.0, 940.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 5.0, 612.0, 27.0 ],
					"text" : "MUC270 ASSIGNMENT 2: TIME AFTER TIME (buffer~, groove~, play~)"
				}
